      ...
      <div className="container">
        <div className="work-experience group" id="portofolio">
          ...
          <div className="item">
            ...
            <p className="text-muted">
              ...
              Filkom students can view galleries and photos from the event. The
              website is designed to allow students to easily access event
              information, register online, and enjoy visual documentation of
              the exciting moments from the event.
            </p>
          </div>
        </div>
        <div className="education group" id="education">
          ...
          <div className="item">
            ...
            <p className="text-muted">
              ...
              Computer Engineering and Networking. During my studies, I gained
              practical skills and in-depth knowledge in computer systems,
              network installation, as well as hardware and software
              maintenance. This education provided me with a solid foundation to
              tackle challenges in the field of information technology.
            </p>
          </div>
          <div className="item">
            <div className="row">
            ...
            <p className="text-muted">
              ...
              understanding of system analysis, business process modeling, and
              IT solutions. Throughout my education, I am gaining valuable
              skills in both technical and analytical aspects of information
              technology, preparing me for a career in this dynamic field.
            </p>
          </div>
        </div>
        ...
        <div className="hobbies group" id="hobbies">
          ...
          <p className="text-center text-muted">
            My main hobby is playing football. I love the energy, teamwork, and
            strategy involved in the game. Its not only a fun way to stay active
            and healthy but also an excellent way to develop discipline and
            build camaraderie with others. Playing football brings excitement
            and joy to my life.
          </p>
        </div>
      </div>
